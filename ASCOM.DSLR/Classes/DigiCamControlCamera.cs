...
namespace ASCOM.DSLR.Classes
{
	public class DigiCamControlCamera : BaseCamera, IDslrCamera
	{
		...
		public void ConnectCamera()
		{
			...
			if (!DeviceManager.SelectedCameraDevice.IsConnected)
			{
				throw new Exception($"Connecting to camera {DeviceManager.SelectedCameraDevice.DisplayName} failed.");
			}
		...
		public void StartExposure(double Duration, bool Light)
		{
			...
			_duration = Duration;
			Debug.WriteLine(DeviceManager.GetHashCode());
			if (!DeviceManager.SelectedCameraDevice.IsConnected)
			{
				DeviceManager.ConnectToCamera();
			}
